...
/*
 * Initialize and return a new point in a specific buffer
 *
 ...
 * initialized with cursor_point_init should be freed this way.
 *
 ...
 * buffer. Calls to cursor_point_enter or equivilent should be made to insert
 ...
 *
 */
int  cursor_point_set_cn(point *p, colno cn);
 ...
 * Unlike cursor_point_cmp, this function is dependent on the buffer of the two
